...
how cross-system divergence depends on \textbf{model size} --- an axis these works do not isolate ---
...
divergence depends on \textbf{model size} (a scale axis these works do not isolate), finding it
washed out at 10M and material at 50M; (ii) we do so under a \textbf{sealed pre-registration} with an
